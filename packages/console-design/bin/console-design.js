...
const { Service } = require('@alicloud/console-toolkit-service');
...
async function invokeService(cmd, args) {
  ...
  const config = {
    presets: [
      [ require.resolve('@alicloud/console-toolkit-preset-console-design'), windProConfig ]
    ],
    plugins:[
      ...(windProConfig.plugins || []),
      require.resolve('@alicloud/console-toolkit-plugin-console-design')
    ]
  };
